...
---
(This blog is the second installment of a [four-part series](/post/stateful-apps-toc))
...
Getting access to _cgroups_ is a challenge for containers, one that includes, in Kubernetes 1.10, a remapping of the node's /sys/fs/cgroup file system and various additional configurations. 
